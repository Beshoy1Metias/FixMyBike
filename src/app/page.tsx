...
const TEXT = {
  ...
  it: {
    heroEyebrow: "Creato dagli studenti per i ciclisti di Padova",
    heroTitleLine1: "Il futuro della",
    heroTitleLine2: "manutenzione bici.",
    heroBody:
      "La piattaforma nata per i ciclisti di Padova. Trova meccanici esperti, acquista ricambi di qualità e scopri i migliori negozi della città — tutto in un unico posto.",
    heroPrimaryCta: "Esplora il Marketplace",
    heroSecondaryCta: "Trova un Negozio",
    heroStats: [
      { num: "Locale", label: "Solo a Padova" },
      { num: "Diretto", label: "Senza commissioni" },
      { num: "Student", label: "Fatto con passione" },
    ],
    ...
    catMechanicBody: "Servizi di riparazione professionali e ciclofficine vicino a te.",
    ...
    steps: [
      ...
      },
      {
        step: "02",
        title: "Scopri",
        desc: "Trova esattamente ciò di cui hai bisogno, da un componente raro a un negozio locale.",
      },
      {
        step: "03",
        title: "Connettiti",
        desc: "Contatta direttamente, visita i negozi e torna in sella in tutta sicurezza.",
      },
    ],
    ctaTitle: "Pronto a pedalare meglio?",
    ctaBody: "Unisciti oggi stesso a centinaia di ciclisti e meccanici della comunità di Padova.",
