            ...
            <div className={`container ${styles.inner}`}>
                <div className={styles.brand}>
                    ...
                    <div className={styles.socials}>
                        ...
                        <a href="https://www.tiktok.com/@fixmybikee" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className={styles.social}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5v3a3 3 0 0 1-3-3v11a4 4 0 1 1-6-4z"></path></svg>
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=61582222752719" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={styles.social}>
