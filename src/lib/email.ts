...
const WELCOME = {
  en: {
    ...
    bodyParagraphs: (firstName: string) => [
      ...
      `One thing I genuinely mean: if you find anything broken, confusing, or missing — or if you just have an idea you think would make this better — please reach out to me directly at <a href="mailto:fixmybike@fix-my-bike.it" style="color:#FF5C28;text-decoration:none;">beshoybassem1@gmail.com</a>. I read every message. This is still early, and the people who use it are the ones who shape it.`,
      `Welcome aboard. 🚲`,
    ],
  ...
  it: {
    ...
    bodyParagraphs: (firstName: string) => [
      ...
      `Una cosa che dico sul serio: se trovi qualcosa che non funziona, che non è chiaro, o che manca — o se hai un'idea che secondo te migliorebbe la piattaforma — scrivimi direttamente a <a href="mailto:fixmybike@fix-my-bike.it" style="color:#FF5C28;text-decoration:none;">beshoybassem1@gmail.com</a>. Leggo ogni messaggio. Siamo ancora agli inizi, e sono le persone che la usano a darle forma.`,
      `Benvenuto a bordo. 🚲`,
    ],
